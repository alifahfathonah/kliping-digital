...
<body>
  ...
  <!-- Search -->
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row about-cols" id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
          ...
          <?php if(count($cari)>0) : ?>
            ...
            <div class="about-col">
              <div class="img">
           <img src="<?php echo base_url(). 'assets/images/'.$data->tulisan_gambar?>" alt="" class="img-fluid">
         </div>
         <h2 class="title"><a href="<?php echo base_url().'assets/images/'.$data->tulisan_file?>"><?php echo substr( $data->tulisan_judul,0,100);?></a></h2>
             <p></p>
            </div>
        </div>
       <?php endforeach ?>
      ...
      <a href="<?php echo base_url().'selengkapnya'?>" class="logo d-flex align-items-center">
        <input type="submit" class="button button-primary" value="Kembali">
      </a>

       <?php else : ?>
          <div style="height: 100px;">
          <h5>Berita Yang Anda Cari Tidak ada yang ditemukan</h5>
          <h6>Coba dengan kata kunci yang lain</h6>
        </div>
      <?php endif ?>
  </div>
